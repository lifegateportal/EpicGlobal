  ...
  return (
    <div className="space-y-4 md:space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
      <div className="border border-zinc-800/60 bg-[#0A0A0A] rounded-xl overflow-hidden shadow-2xl">
        <div className="p-4 md:p-6 border-b border-zinc-800/60">
          <div>
            <div className="flex flex-wrap items-center gap-2.5 mb-1.5">
              <h2 className="text-base md:text-lg font-medium text-zinc-100">epicglobal.app</h2>
            ...
            <a href="https://epicglobal.app" className="text-xs md:text-sm text-zinc-500 hover:text-zinc-300 transition-colors break-all">https://epicglobal.app</a>
            {connectionStatusDetail && (
              <p className="mt-2.5 text-xs text-zinc-500">{connectionStatusDetail}</p>
            )}
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-zinc-800/60 bg-zinc-900/20">
      ...
      <div className="border border-zinc-800/60 bg-[#0A0A0A] rounded-xl overflow-hidden shadow-2xl">
        <div className="p-4 md:p-6 border-b border-zinc-800/60 flex justify-between items-center bg-zinc-900/20">
          <h3 className="text-base md:text-lg font-medium text-zinc-100 flex items-center gap-2"><Activity size={18} className="text-zinc-400" /> System Metrics</h3>
        </div>
        <div className="p-3 md:p-6 h-[240px] md:h-[300px] w-full">
